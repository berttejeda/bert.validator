(function(exports, d32) {
  ...
  function deriveOptions(jsonOptions) {
    ...
    const booleanKeys = ["zoom", "pan", "checkboxPersistence"];
    booleanKeys.forEach((key) => {
      const value = options[key];
      if (value != null) derivedOptions[key] = !!value;
    });
    const { extraCss } = options;
    if (extraCss == null ? void 0 : extraCss.length) {
      const cssText = extraCss.map((s) => s.replace(/<\/?style[^>]*>/gi, "")).join("\n");
  ...
  function replaceSVGWithCheckbox(svg) {
    var _a;
    const foreignObject = svg.closest("foreignObject");
    if (!foreignObject) return null;
    const textContent = ((_a = foreignObject.textContent) == null ? void 0 : _a.trim()) || "";
    const checkboxId = getCheckboxId(textContent);
    const checkbox = document.createElement("input");
    checkbox.type = "checkbox";
    checkbox.style.cssText = "margin-right: 6px; cursor: pointer; width: 16px; height: 16px; vertical-align: middle;";
  ...
  function processCheckboxes(container = document.body) {
    const svgs = container.querySelectorAll(CHECKBOX_SELECTOR);
    let count2 = 0;
    svgs.forEach((svg) => {
  ...
  class CheckboxPersistenceManager {
    ...
    init() {
      ...
      const tryProcess = () => {
        const svgs = this.container.querySelectorAll(CHECKBOX_SELECTOR);
        if (svgs.length > 0) {
        ...
        mutations.forEach((mutation) => {
          mutation.addedNodes.forEach((node) => {
            if (node.nodeType === Node.ELEMENT_NODE) {
              const element = node;
              const newSvgs = element.querySelectorAll ? element.querySelectorAll(CHECKBOX_SELECTOR) : [];
  ...
  class Markmap {
    ...
    setOptions(opts) {
      ...
      if ((opts == null ? void 0 : opts.checkboxPersistence) !== void 0 && oldCheckboxPersistence !== this.options.checkboxPersistence) {
        if (this.options.checkboxPersistence) {
          this._initCheckboxPersistence();
        } else {
    ...
    _destroyCheckboxPersistence() {
      if (this._checkboxManager) {
        this._checkboxManager.destroy();
        this._checkboxManager = void 0;
      }
    }
    ...
    async renderData(originData) {
      ...
      if (this._checkboxManager) {
        setTimeout(() => {
          var _a;
          (_a = this._checkboxManager) == null ? void 0 : _a.process();
        }, 0);
      }
    }
    transition(sel) {
    ...
    getCheckboxStates() {
      var _a;
      return ((_a = this._checkboxManager) == null ? void 0 : _a.getStates()) || {};
    }
    /**
    ...
    clearCheckboxStates() {
      var _a;
      (_a = this._checkboxManager) == null ? void 0 : _a.clearStates();
    }
    /**
    ...
    processCheckboxes() {
      var _a;
      return ((_a = this._checkboxManager) == null ? void 0 : _a.process()) || 0;
    }
  ...
  exports.CheckboxPersistenceManager = CheckboxPersistenceManager;
  exports.Markmap = Markmap;
  exports.childSelector = childSelector;
  exports.clearCheckboxStates = clearCheckboxStates;
  exports.defaultColorFn = defaultColorFn;
  exports.defaultOptions = defaultOptions;
  exports.deriveOptions = deriveOptions;
  exports.getCheckboxId = getCheckboxId;
  exports.globalCSS = globalCSS;
  exports.isMacintosh = isMacintosh;
  exports.lineWidthFactory = lineWidthFactory;
  exports.loadCSS = loadCSS;
  exports.loadCheckboxStates = loadCheckboxStates;
  exports.loadJS = loadJS;
  exports.processCheckboxes = processCheckboxes;
  exports.refreshHook = refreshHook;
  exports.replaceSVGWithCheckbox = replaceSVGWithCheckbox;
  exports.saveCheckboxStates = saveCheckboxStates;
