...
`;
  ...
  const name$6 = "checkbox";
  const images = {
    " ": svgUnmarked.trim(),
    x: svgMarked.trim()
  };
  const plugin$4 = definePlugin({
    name: name$6,
...
${end2.comment}` : end2.comment;
  ...
  const config$2 = {
    ...
    preloadScripts: preloadScripts$2,
    styles: styles$1
  };
  const plugin$3 = definePlugin({
    ...
    transform(transformHooks) {
      var _a2, _b, _c;
      let loading;
      const preloadScripts2 = ((_b = (_a2 = plugin$3.config) == null ? void 0 : _a2.preloadScripts) == null ? void 0 : _b.map(
      ...
      transformHooks.beforeParse.tap((_, context) => {
        enableFeature = () => {
          context.features[name$4] = true;
        };
      });
      return {
        styles: (_c = plugin$3.config) == null ? void 0 : _c.styles
      };
    }
  });
  ...
  const plugin$2 = definePlugin({
    ...
    transform(transformHooks) {
          ...
          ["extraJs", "extraCss"].forEach((key) => {
            ...
            if (value) {
              markmap[key] = addDefaultVersions(
                value,
                name$3,
                ((_b2 = (_a4 = plugin$2.config) == null ? void 0 : _a4.versions) == null ? void 0 : _b2.katex) || ""
              );
            }
          });
        }
      ...
      return {
        ...
        scripts: (_d = plugin$2.config) == null ? void 0 : _d.scripts
      };
    }
  });
  const name$2 = "mermaid";
...
`;
            ...
            const runMermaid = () => {
              ...
              if (!mermaid) return;
              try {
                const userConfig = window.__mermaidConfig || {};
                const defaults = {
                  startOnLoad: false,
                  theme: "default",
              ...
              mermaidEls.forEach((el) => {
                if (el.textContent && !el.querySelector("svg")) {
                  if (typeof mermaid.render === "function") {
                    ...
                    const promise = mermaid.render(id, el.textContent).then(({ svg: renderedSvg }) => {
                ...
                for (const mutation of mutationsList) {
                  if (mutation.type === "childList" && mutation.addedNodes.length > 0) {
                    for (let i = 0; i < mutation.addedNodes.length; i++) {
                      ...
                      if (node.nodeType === 1) {
                        const el = node;
                        if (((_a2 = el.classList) == null ? void 0 : _a2.contains("mermaid")) || ((_b = el.querySelector) == null ? void 0 : _b.call(el, ".mermaid"))) {
                          shouldRender = true;
                          break;
                        }
                      }
  ...
  const plugin$1 = definePlugin({
    ...
    transform(transformHooks) {
      ...
      transformHooks.parser.tap((md) => {
        if (md.renderer.rules.fence) {
          md.renderer.rules.fence = wrapFunction(
            ...
            (render2, tokens, idx, ...rest) => {
              const token = tokens[idx];
              if (token.info === "mermaid") {
                enableFeature();
                return `<pre class="mermaid">${token.content}</pre>`;
              }
              return render2(tokens, idx, ...rest);
            }
          );
        }
      });
      ...
      return {
        scripts: (_a2 = plugin$1.config) == null ? void 0 : _a2.scripts
      };
    }
  });
  const name$1 = "npmUrl";
